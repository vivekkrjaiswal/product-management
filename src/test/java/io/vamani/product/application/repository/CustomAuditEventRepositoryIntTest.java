package io.vamani.product.application.repository;

import io.vamani.product.application.ProductmanagementApp;
import io.vamani.product.application.config.Constants;
import io.vamani.product.application.config.audit.AuditEventConverter;
import io.vamani.product.application.domain.PersistentAuditEvent;
...
import static io.vamani.product.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
